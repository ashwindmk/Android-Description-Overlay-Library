...
public class SharedPreferencesManager {
    ...
    private static final String PREFS_NAME = "description_overlay_prefs";
    private static final String STATUS = "status_";
    private String showcaseID = null;
    private Context context;

    public SharedPreferencesManager(Context context, String showcaseID) {
        this.context = context;
        this.showcaseID = showcaseID;
    }

    /***
     * METHODS FOR INDIVIDUAL DESCRIPTION VIEWS
     */
    boolean hasFired() {
    ...
    /***
     * METHODS FOR DESCRIPTION SEQUENCES
     */
